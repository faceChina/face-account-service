...
public class SignUtil {
	 ...
	 * @author Administrator
	 */
	public static String jieMi(String miwen) throws Exception {  //utf-8
//		Base64 base64 = new Base64();
//		byte[] ddd = base64.decode(debytes);
//		String miwen= new String(ddd,"utf-8");
//		System.out.println("miwen:********************************:"+miwen);
        try {
        	PKCS7 p7 = new PKCS7(new BASE64Decoder().decodeBuffer(miwen));
			return new String(p7.getContentInfo().getContentBytes(),"gbk"); //luanma
		} catch (Exception e) {
			throw e;
		}
	}
